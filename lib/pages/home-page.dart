...
class _HomePageState extends State<HomePage> {
  ...
  String? getAmountErrorText(String value) {
    if (value.isEmpty) {
  ...
  bool _validate = false; // Flag to track validation state
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: _validate && newExpenseNameController.text.isEmpty
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: _validate
                      ? getAmountErrorText(newExpenseAmountController.text)
                      : null,
                ),
              ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_validate && selectedCategory == null)
                          const Padding(
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      _validate = true; // Trigger validation
                    });

                    if (newExpenseNameController.text.isNotEmpty &&
                        newExpenseAmountController.text.isNotEmpty &&
                        category != null && getAmountErrorText(newExpenseAmountController.text) == null) {
                      save();
                    }
                  },
  ...
  Offset offset = Offset(20.0, 20.0); // Initial position of the button
